...
export const EditTodoForm = ({ editTodo, task, cancelEditTask }) => {
  ...
  return (
    <div className="w-full relative flex gap-1 items-center justify-center bg-[#230e28] rounded-xl h-fit">
      <textarea
        type="text"
        value={value}
        onChange={(e) => setValue(e.target.value)}
        className="bg-[#3d2243] text-[#ffe4f9] px-2 rounded-xl w-full  mr-auto break-all whitespace-pre-wrap p-2 h-auto resize-none max-h-40"
      ...
      >
        <svg className="w-3 h-3 xsm:w-8 xsm:h-8" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M0 14.545L1.455 16 8 9.455 14.545 16 16 14.545 9.455 8 16 1.455 14.545 0 8 6.545 1.455 0 0 1.455 6.545 8z" fillRule="evenodd"></path> </g></svg>
      </button>
    </div>
  )
}